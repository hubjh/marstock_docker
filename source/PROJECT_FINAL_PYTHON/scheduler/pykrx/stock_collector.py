...
# 011170 롯데케미칼
    ...
    # 추려낼 종목코드 리스트
    selected_codes = ["005930", "029780", "034220", "051910", "035720", "323410", "004170", "139480", "004000", "011170"]

    # 종목코드가 선택된 종목코드 리스트에 속하는 행만 필터링
    df = df[df['종목코드'].isin(selected_codes)]
...
def create_stock_files(start_date_str):
    logging.info("create_stock_files") ###===================
    try:
        logging.info("create_stock_files try") ###===================
        ...
        logging.info("create_stock_files exception") ###===================
